...
!function (e) {
    ...
    !function (t) {
        ...
        var t, o = "mCustomScrollbar", a = "mCS", n = ".mCustomScrollbar", i = {
            ...
            }).find(".mCSB_dragger_bar").css({"line-height": c[0] + "px"}), r[1].css({width: u, "max-width": r[1].parent().width() - 10})
        }, b = function () {
            ...
            r.bind("focusin." + i, function (o) {
                ...
                a.is(n.advanced.autoScrollOnFocus) && (N(t), clearTimeout(t[0]._focusTimeout), t[0]._focusTimer = i ? (s + 17) * i : 0, t[0]._focusTimeout = setTimeout(function () {
                    ...
                    "x" === n.axis || i[0] || V(t, e[0].toString(), {
                        ...
                        overwrite: c,
                        dur: s
                    }), "y" === n.axis || i[1] || V(t, e[1].toString(), {dir: "x", scrollEasing: "mcsEaseInOut", overwrite: c, dur: s})
                }, t[0]._focusTimer))
            })
        }, P = function () {
