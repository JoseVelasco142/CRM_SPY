...
!function (a) {
    ...
    var Pa = a.fullCalendar = {version: "2.6.1", internalApiVersion: 3}, Qa = Pa.views = {};
    ...
    var Ta = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], Ua = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"];
    Pa.log = function () {
    ...
    kb.mixin({
        mousedOverSeg: null, isDraggingSeg: !1, isResizingSeg: !1, isDraggingExternal: !1, segs: null, renderEvents: function (a) {
            ...
            var c, d = this, e = this.view, f = e.calendar, i = a.el, j = a.event, k = new jb(a.el, {
                ...
                distance: 5, scroll: e.opt("dragScroll"), subjectEl: i, subjectCenter: !0, listenStart: function (a) {
                    k.hide(), k.start(a)
    ...
    var ob = Pa.View = ra.extend({
        ...
        computeScrollerHeight: function (a) {
            ...
            return b = this.el.add(d), b.css({position: "relative", left: -1}), c = this.el.outerHeight() - d.height(), b.css({
                position: "",
                left: ""
            }), a - c
        },
