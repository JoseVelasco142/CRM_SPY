...
!function (a) {
    ...
    function l() {
        ...
        var d = {};
        return {
            defaults: n, dialog: function (d, e, f, g) {
    ...
    var m = {ENTER: 13, ESC: 27, F1: 112, F12: 123, LEFT: 37, RIGHT: 39}, n = {
        modal: !0,
        basic: !1,
        frameless: !1,
        movable: !0,
        ...
        function z(a, b) {
            for (var c = o.indexOf(b), d = c + 1; d < o.length; d += 1)if (o[d].isModal())return;
        ...
        function S(a) {
            ...
            var b = o[o.length - 1], c = a.keyCode;
        ...
        function V(a, b) {
            if (!b)for (var c = o.length - 1; c > -1; c -= 1)if (o[c].isModal()) {
                b = o[c];
                break
            }
            if (b && b.isModal()) {
        ...
        var ua, va, wa = [], xa = null, ya = a.navigator.userAgent.indexOf("Safari") > -1 && a.navigator.userAgent.indexOf("Chrome") < 0, za = {
        ...
        }, Ba = !1, Ca = !1, Da = null, Ea = 0, Fa = 0, Ga = "pageX", Ha = "pageY", Ia = null, Ja = !1, Ka = null, La = null, Ma = Number.Nan, Na = 0, Oa = 0, Pa = 0;
        return {
            __init: l, isOpen: function () {
                ...
                var c = this, d = B(this, this.__internal.options, function (a, b, d) {
                    A(c, a, b, d)
                }, a, b);
                if ("get" === d.op)return d.found ? d.value : "undefined" != typeof this.settings ? B(this, this.settings, this.settingUpdated || function () {
                    }, a, b).value : void 0;
                if ("set" === d.op) {
    ...
    u.dialog("alert", function () {
        return {
            main: function (a, b, c) {
                ...
                return {
                    buttons: [{text: u.defaults.glossary.ok, key: m.ESC, invokeOnClose: !0, className: u.defaults.theme.ok}],
        ...
        return {
            ...
            setup: function () {
                return {
                    ...
                    }, {text: u.defaults.glossary.cancel, key: m.ESC, invokeOnClose: !0, className: u.defaults.theme.cancel}],
                    focus: {element: 0, select: !1},
                    options: {maximizable: !1, resizable: !1}
                }
            },
